        ...
        <section className="relative py-24 lg:py-40 overflow-hidden bg-background">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-5xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-800/50 border border-zinc-700 text-sm text-zinc-400 mb-8 backdrop-blur-sm">
                        <span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
                        Accepting new enterprise partners for Q4
                    </div>

                    <h1 className="text-6xl lg:text-8xl font-bold tracking-tighter mb-8 leading-[1.1] text-white">
                        Build Right. <br />
                    ...
                    <p className="text-xl lg:text-2xl text-zinc-400 mb-12 max-w-2xl mx-auto leading-relaxed font-light">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        ...
                        <Link to="/services" className="w-full sm:w-auto px-8 py-4 bg-zinc-900 border border-zinc-700 text-white font-semibold text-lg rounded-lg hover:bg-zinc-800 hover:border-zinc-600 transition-all">
                            Explore Services
                        </Link>
                    </div>
                </div>
